   ...
   /* Image image;
    ...
    private void createPDF(String pdfFilename) {
        ...
        try {
            ...
            File path = new File(Environment.getExternalStorageDirectory() + "/Invoice");
            Log.i("---1", path + "");
            if (!path.exists()) {
                File wallpaperDirectory = new File("/sdcard/Invoice/");
...
//----------//
          ...
          *//*  try {
                image = Image.getInstance("src/resources/logo.jpg");//Header Image
            ...
            Log.i("---------PDF", "Created Successfully");
